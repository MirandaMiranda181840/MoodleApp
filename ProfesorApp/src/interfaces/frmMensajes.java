...
public class frmMensajes extends javax.swing.JFrame {
    ...
    public void cargarUsuarios(){
        ...
        usuarios = new RESTConexion.UsuarioResource_JerseyClient().obtenerPadres(DatosPadre[].class, parentUser.getToken());
        for (DatosPadre re : usuarios) {
            dlm.addElement(re.getFullname());
        }
