...
public class pruebas {
    ...
    public static void main(String[] args) {
        ...
        Curso[] res = new RESTConexion.CalificacionesResource_JerseyClient().getCursos(Curso[].class, token);
        ...
        Asignacion[] res2 = new RESTConexion.CalificacionesResource_JerseyClient().getAsignaciones(Asignacion[].class, cursoId, token);
